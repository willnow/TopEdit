...
namespace TopoEdit.EventHandler
{
    ...
    class ZoomSelectedBlockRectHandler : IRangeEventHandler
    {
                ...
                if (e.MouseAnchor != null)
                {
                    if ((e.MouseSelectedIcon != null) && (e.MouseSelectedIcon is SelectedRange))
                    {
                        ...
                        if ((m_selIcon != null) && (m_selIcon is SelectedDraw))
                        {
                            ...
                            ZoomAndMoveSelBlockRectInPageByAnchorVisitor visitor = new ZoomAndMoveSelBlockRectInPageByAnchorVisitor(zoom, move);
                            e.RangeData.Accept(visitor);
